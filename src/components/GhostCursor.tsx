 ...
 * It uses custom shaders for fluid simulation and post-processing for bloom and grain.
 */
export const GhostCursor: React.FC<GhostCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const filmPass = new ShaderPass(FilmGrainShader as unknown as THREE.ShaderMaterialParameters);
