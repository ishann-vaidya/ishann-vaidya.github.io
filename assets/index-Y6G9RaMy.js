...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mo(e,t,n){let r=new Float32Array($),i=new q(0,1,0);return new Ki({name:`SphericalGaussianBlur`,defines:{n:$,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:_o(),fragmentShader:`
	...
	`}var vo=class extends vn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Mi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},il=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},al=new ba(-1,1,1,-1,0,1),ol=new class extends Zr{constructor(){super(),this.setAttribute(`position`,new zr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new zr([0,2,0,0,2,0],2))}},sl=class{constructor(e){this._mesh=new bi(ol,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,al)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},cl=class extends il{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ki?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ui.clone(e.uniforms),this.material=new Ki({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new sl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ll=class extends il{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},ul=class extends il{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},dl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new vn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:R}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new cl(rl),this.copyPass.material.blending=0,this.timer=new Ta}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ll!==void 0&&(r instanceof ll?n=!0:r instanceof ul&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},fl=class extends il{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},pl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new X(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ml.BlurDirectionX=new K(1,0),ml.BlurDirectionY=new K(0,1);var hl=({className:e,style:t,trailLength:n=50,inertia:r=.5,grainIntensity:i=.05,bloomStrength:a=.1,bloomRadius:o=1,bloomThreshold:s=.025,brightness:c=1,color:l=`#B19EEF`,mixBlendMode:u=`screen`,edgeIntensity:d=0,maxDevicePixelRatio:f=1,targetPixels:p,fadeDelayMs:m,fadeDurationMs:h,zIndex:g=9999})=>{let v=(0,_.useRef)(null),y=(0,_.useRef)(null),b=(0,_.useRef)(null),x=(0,_.useRef)(null),C=(0,_.useRef)(null),w=(0,_.useRef)(null),T=(0,_.useRef)([]),E=(0,_.useRef)(0),D=(0,_.useRef)(null),O=(0,_.useRef)(null),k=(0,_.useRef)(new K(.5,.5)),A=(0,_.useRef)(new K(0,0)),j=(0,_.useRef)(1),ee=(0,_.useRef)(typeof performance<`u`?performance.now():Date.now()),M=(0,_.useRef)(!1),N=(0,_.useRef)(!1),te=(0,_.useMemo)(()=>typeof window<`u`&&(`ontouchstart`in window||navigator.maxTouchPoints>0),[]),P=p??(te?9e5:13e5),F=m??(te?500:1e3),ne=h??(te?1e3:1500),re=(0,_.useMemo)(()=>({uniforms:{tDiffuse:{value:null},iTime:{value:0},intensity:{value:i}},vertexShader:`
        varying vec2 vUv;
        void main(){
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `}),[i]),ie=(0,_.useMemo)(()=>new cl({uniforms:{tDiffuse:{value:null}},vertexShader:`
          varying vec2 vUv;
          void main(){
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),[]);function ae(e){let t=e.getBoundingClientRect(),n=Math.min(Math.max(1,t.width),Math.max(1,t.height));return Math.max(.5,Math.min(2,n/600))}(0,_.useEffect)(()=>{let e=v.current;if(!e)return;let t=new nl({antialias:!te,alpha:!0,depth:!1,stencil:!1,powerPreference:`default`,premultipliedAlpha:!1,preserveDrawingBuffer:!1});t.setClearColor(0,0),y.current=t,t.domElement.style.pointerEvents=`none`,u?t.domElement.style.mixBlendMode=String(u):t.domElement.style.removeProperty(`mix-blend-mode`),t.domElement.style.display=`block`,t.domElement.style.width=`100%`,t.domElement.style.height=`100%`,t.domElement.style.background=`transparent`,e.appendChild(t.domElement);let i=new rr,p=new ba(-1,1,1,-1,0,1),m=new Li(2,2),h=Math.max(1,Math.floor(n));T.current=Array.from({length:h},()=>new K(.5,.5)),E.current=0;let g=new X(l),_=new Ki({defines:{MAX_TRAIL_LENGTH:h},uniforms:{iTime:{value:0},iResolution:{value:new q(1,1,1)},iMouse:{value:new K(.5,.5)},iPrevMouse:{value:T.current.map(e=>e.clone())},iOpacity:{value:1},iScale:{value:1},iBaseColor:{value:new q(g.r,g.g,g.b)},iBrightness:{value:c},iEdgeIntensity:{value:d}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = vec4(position, 1.0);
  ...
  `,transparent:!0,depthTest:!1,depthWrite:!1});x.current=_;let S=new bi(m,_);i.add(S);let I=new dl(t);b.current=I;let L=new fl(i,p);I.addPass(L);let R=new ml(new K(1,1),a,o,s);C.current=R,I.addPass(R);let oe=new cl(re);w.current=oe,I.addPass(oe),I.addPass(ie);let se=()=>{let n=e.getBoundingClientRect(),r=Math.max(1,Math.floor(n.width)),i=Math.max(1,Math.floor(n.height)),a=Math.min(typeof window<`u`&&window.devicePixelRatio||1,f),o=r*i*a*a,s=a*(o<=P?1:Math.max(.5,Math.min(1,Math.sqrt(P/Math.max(1,o)))));t.setPixelRatio(s),t.setSize(r,i,!1),I.setPixelRatio?.(s),I.setSize(r,i);let c=Math.max(1,Math.floor(r*s)),l=Math.max(1,Math.floor(i*s));_.uniforms.iResolution.value.set(c,l,1),_.uniforms.iScale.value=ae(e),R.setSize(c,l)};se();let ce=new ResizeObserver(se);O.current=ce,ce.observe(e);let le=typeof performance<`u`?performance.now():Date.now(),ue=()=>{let e=performance.now(),t=(e-le)/1e3,n=x.current,i=b.current;if(M.current)A.current.set(k.current.x-n.uniforms.iMouse.value.x,k.current.y-n.uniforms.iMouse.value.y),n.uniforms.iMouse.value.copy(k.current),j.current=1;else{A.current.multiplyScalar(r),A.current.lengthSq()>1e-6&&n.uniforms.iMouse.value.add(A.current);let t=e-ee.current;if(t>F){let e=Math.min(1,(t-F)/ne);j.current=Math.max(0,1-e)}}let a=T.current.length;E.current=(E.current+1)%a,T.current[E.current].copy(n.uniforms.iMouse.value);let o=n.uniforms.iPrevMouse.value;for(let e=0;e<a;e++){let t=(E.current-e+a)%a;o[e].copy(T.current[t])}if(n.uniforms.iOpacity.value=j.current,n.uniforms.iTime.value=t,w.current?.uniforms?.iTime&&(w.current.uniforms.iTime.value=t),i.render(),!M.current&&j.current<=.001){N.current=!1,D.current=null;return}D.current=requestAnimationFrame(ue)},de=()=>{N.current||(N.current=!0,D.current=requestAnimationFrame(ue))},fe=t=>{let n=e.getBoundingClientRect(),r=Zt.clamp((t.clientX-n.left)/Math.max(1,n.width),0,1),i=Zt.clamp(1-(t.clientY-n.top)/Math.max(1,n.height),0,1);k.current.set(r,i),M.current=!0,ee.current=performance.now(),de()};return window.addEventListener(`pointermove`,fe,{passive:!0}),window.addEventListener(`mousemove`,fe,{passive:!0}),de(),()=>{D.current&&cancelAnimationFrame(D.current),N.current=!1,D.current=null,window.removeEventListener(`pointermove`,fe),window.removeEventListener(`mousemove`,fe),O.current?.disconnect(),i.clear(),m.dispose(),_.dispose(),I.dispose(),t.dispose(),t.domElement&&t.domElement.parentElement&&t.domElement.parentElement.removeChild(t.domElement)}},[n,r,i,a,o,s,P,F,ne,te,l,c,u,d,f]),(0,_.useEffect)(()=>{if(x.current){let e=new X(l);x.current.uniforms.iBaseColor.value.set(e.r,e.g,e.b)}},[l]),(0,_.useEffect)(()=>{x.current&&(x.current.uniforms.iBrightness.value=c)},[c]),(0,_.useEffect)(()=>{x.current&&(x.current.uniforms.iEdgeIntensity.value=d)},[d]),(0,_.useEffect)(()=>{w.current?.uniforms?.intensity&&(w.current.uniforms.intensity.value=i)},[i]),(0,_.useEffect)(()=>{let e=y.current?.domElement;e&&(u?e.style.mixBlendMode=String(u):e.style.removeProperty(`mix-blend-mode`))},[u]);let I=(0,_.useMemo)(()=>({position:`fixed`,top:0,left:0,width:`100vw`,height:`100vh`,pointerEvents:`none`,zIndex:g,...t}),[g,t]);return(0,S.jsx)(`div`,{ref:v,className:`pointer-events-none fixed inset-0 ${e??``}`,style:I})},gl=[{id:`about`,label:`About`},{id:`skills`,label:`Skills`},{id:`projects`,label:`Projects`},{id:`experience`,label:`Experience`},{id:`contact`,label:`Contact`}];function _l({theme:e,onToggleTheme:t}){let[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let e=()=>a(window.scrollY>24);return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]);let o=e=>{r(!1),document.getElementById(e)?.scrollIntoView({behavior:`smooth`})};return(0,S.jsx)(`header`,{className:`site-header ${i?`site-header--scrolled`:``}`,children:(0,S.jsxs)(`div`,{className:`site-header__inner`,children:[(0,S.jsxs)(`a`,{href:`#top`,className:`site-header__brand`,onClick:e=>{e.preventDefault(),window.scrollTo({top:0,behavior:`smooth`})},children:[(0,S.jsx)(`span`,{className:`site-header__mark`,"aria-hidden":!0}),y.name]}),(0,S.jsxs)(`div`,{className:`site-header__controls`,children:[(0,S.jsxs)(`nav`,{className:`site-header__nav ${n?`site-header__nav--open`:``}`,children:[gl.map(e=>(0,S.jsx)(`button`,{type:`button`,className:`site-header__link`,onClick:()=>o(e.id),children:e.label},e.id)),(0,S.jsx)(`a`,{className:`site-header__resume btn btn--primary`,href:`https://drive.google.com/file/d/1JJVmHJgMRmp25RqFs2cUJMrKAaH0LsIT/view?usp=sharing`,target:`_blank`,rel:`noopener noreferrer`,download:!0,children:`Resume`})]}),(0,S.jsx)(`button`,{type:`button`,className:`site-header__theme-btn`,"aria-label":`Switch to ${e===`dark`?`light`:`dark`} mode`,onClick:t,children:e===`dark`?`Light mode`:`Dark mode`}),(0,S.jsxs)(`button`,{type:`button`,className:`site-header__menu-btn`,"aria-expanded":n,"aria-label":`Toggle navigation`,onClick:()=>r(e=>!e),children:[(0,S.jsx)(`span`,{}),(0,S.jsx)(`span`,{}),(0,S.jsx)(`span`,{})]})]})]})})}var vl=``+new URL(`hero-n1VrE-1h.png`,import.meta.url).href;function yl(e=.06){let[t,n]=(0,_.useState)(0);return(0,_.useEffect)(()=>{let t=()=>{n(window.scrollY*e)};return t(),window.addEventListener(`scroll`,t,{passive:!0}),()=>window.removeEventListener(`scroll`,t)},[e]),t}function bl(){return(0,S.jsxs)(`section`,{id:`top`,className:`hero`,children:[(0,S.jsxs)(`div`,{className:`hero__bg`,style:{transform:`translate3d(0, ${yl(.04)}px, 0)`},"aria-hidden":!0,children:[(0,S.jsx)(`div`,{className:`hero__gradient`}),(0,S.jsx)(`div`,{className:`hero__grid`}),(0,S.jsx)(`div`,{className:`hero__noise`})]}),(0,S.jsxs)(`div`,{className:`hero__content hero__content--split`,children:[(0,S.jsxs)(`div`,{className:`hero__copy`,children:[(0,S.jsx)(`p`,{className:`hero__eyebrow`,children:`Hello, I am`}),(0,S.jsx)(`h1`,{className:`hero__title`,children:(0,S.jsx)(`span`,{children:y.name})}),(0,S.jsxs)(`p`,{className:`hero__role`,children:[y.role,` | Exploring Machine Learning`]}),(0,S.jsx)(`p`,{className:`hero__tagline`,children:y.tagline}),(0,S.jsx)(`p`,{className:`hero__support`,children:y.heroSupporting}),(0,S.jsxs)(`div`,{className:`hero__actions`,children:[(0,S.jsx)(`a`,{className:`btn btn--primary`,href:`#projects`,children:`View My Work`}),(0,S.jsx)(`a`,{className:`btn btn--ghost`,href:`#contact`,children:`Get in touch`})]})]}),(0,S.jsxs)(`figure`,{className:`hero__visual glass`,"aria-label":`Profile illustration`,children:[(0,S.jsx)(`img`,{className:`hero__visual-image`,src:vl,alt:`Profile illustration`}),(0,S.jsx)(`figcaption`,{className:`hero__visual-caption`,children:`Building clean systems, thoughtful interfaces, and useful AI.`})]}),(0,S.jsx)(`div`,{className:`hero__signal hero__signal--one`,"aria-hidden":!0}),(0,S.jsx)(`div`,{className:`hero__signal hero__signal--two`,"aria-hidden":!0})]})]})}function xl(){let{ref:e,visible:t}=b();return(0,S.jsxs)(`section`,{id:`projects`,className:`section projects`,ref:e,children:[(0,S.jsxs)(`div`,{className:`section__head reveal ${t?`reveal--visible`:``}`,children:[(0,S.jsx)(`span`,{className:`section__label`,children:`Projects`}),(0,S.jsx)(`h2`,{className:`section__title`,children:`Selected work`}),(0,S.jsx)(`p`,{className:`section__lede`,children:`Problem-first builds with clear technical boundaries and links to source.`})]}),(0,S.jsx)(`div`,{className:`projects__list`,children:y.projects.map((e,n)=>(0,S.jsxs)(`article`,{className:`projects__card glass reveal ${t?`reveal--visible`:``}`,style:{transitionDelay:`${.08+n*.1}s`},children:[(0,S.jsxs)(`div`,{className:`projects__card-top`,children:[(0,S.jsxs)(`div`,{children:[(0,S.jsx)(`h3`,{className:`projects__title`,children:e.title}),(0,S.jsxs)(`p`,{className:`projects__meta`,children:[(0,S.jsx)(`span`,{children:e.year}),(0,S.jsx)(`span`,{className:`projects__dot`,"aria-hidden":!0}),(0,S.jsx)(`span`,{children:e.badge})]})]}),(0,S.jsx)(`div`,{className:`projects__links`,children:e.links.map(e=>e.href===`#`?(0,S.jsxs)(`a`,{href:e.href,className:`projects__link`,"aria-disabled":`true`,onClick:e=>e.preventDefault(),children:[e.label,(0,S.jsx)(`span`,{"aria-hidden":!0,className:`projects__link-arrow`,children:`↗`})]},e.href+e.label):(0,S.jsxs)(`a`,{href:e.href,target:`_blank`,rel:`noopener noreferrer`,className:`projects__link`,children:[e.label,(0,S.jsx)(`span`,{"aria-hidden":!0,className:`projects__link-arrow`,children:`↗`})]},e.href))})]}),(0,S.jsxs)(`div`,{className:`projects__body`,children:[(0,S.jsxs)(`div`,{className:`projects__block`,children:[(0,S.jsx)(`span`,{className:`projects__label`,children:`Problem`}),(0,S.jsx)(`p`,{children:e.problem})]}),(0,S.jsxs)(`div`,{className:`projects__block`,children:[(0,S.jsx)(`span`,{className:`projects__label`,children:`Solution`}),(0,S.jsx)(`p`,{children:e.solution})]}),(0,S.jsxs)(`div`,{className:`projects__block`,children:[(0,S.jsx)(`span`,{className:`projects__label`,children:`Impact`}),(0,S.jsx)(`p`,{children:e.impact})]})]}),(0,S.jsx)(`div`,{className:`projects__stack`,children:e.stack.map(e=>(0,S.jsx)(`span`,{className:`projects__pill`,children:e},e))})]},e.title))})]})}function Sl(){let{ref:e,visible:t}=b();return(0,S.jsxs)(`section`,{id:`skills`,className:`section skills`,ref:e,children:[(0,S.jsxs)(`div`,{className:`section__head reveal ${t?`reveal--visible`:``}`,children:[(0,S.jsx)(`span`,{className:`section__label`,children:`Skills`}),(0,S.jsx)(`h2`,{className:`section__title`,children:`Tools and crafts`}),(0,S.jsx)(`p`,{className:`section__lede`,children:`Grouped for clarity—from languages and web stacks to ML workflows and collaboration.`})]}),(0,S.jsx)(`div`,{className:`skills__grid`,children:y.skills.map((e,n)=>(0,S.jsxs)(`div`,{className:`glass skills__card reveal ${t?`reveal--visible`:``}`,style:{transitionDelay:`${.06+n*.05}s`},children:[(0,S.jsx)(`h3`,{className:`skills__card-title`,children:e.title}),(0,S.jsx)(`ul`,{className:`skills__tags`,children:e.items.map(e=>(0,S.jsx)(`li`,{className:`skills__tag`,children:e},e))})]},e.title))})]})}function Cl(){let[e,t]=(0,_.useState)(()=>typeof window>`u`?`dark`:window.localStorage.getItem(`portfolio-theme`)===`light`?`light`:`dark`);return(0,_.useEffect)(()=>{document.documentElement.dataset.theme=e,document.documentElement.style.colorScheme=e,window.localStorage.setItem(`portfolio-theme`,e)},[e]),(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(hl,{color:e===`light`?`#6366F1`:`#B19EEF`,brightness:e===`light`?.75:.85,bloomStrength:.15,bloomRadius:.6,bloomThreshold:.02,trailLength:24,inertia:.4,grainIntensity:.02,fadeDelayMs:200,fadeDurationMs:1200,mixBlendMode:`screen`,style:{opacity:.55},zIndex:0}),(0,S.jsx)(_l,{theme:e,onToggleTheme:()=>t(e=>e===`dark`?`light`:`dark`)}),(0,S.jsxs)(`main`,{className:`app-main`,children:[(0,S.jsx)(bl,{}),(0,S.jsx)(C,{}),(0,S.jsx)(Sl,{}),(0,S.jsx)(xl,{}),(0,S.jsx)(T,{}),(0,S.jsx)(w,{})]}),(0,S.jsx)(D,{})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,S.jsx)(_.StrictMode,{children:(0,S.jsx)(Cl,{})}));